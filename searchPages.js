...
function FilterList(endPoint, endPointParams)
{
	...
	this.addFormattedRangeSlider = function(appendTo, title, searchName, values, step, endPointName1, endPointName2, formatter, scale)
	{
		scale = scale || "linear";
		...
		var output = '<p class="lead">'+title+'</p>' + '<br>'+
		             '<div class="range">' +
